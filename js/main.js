...
const FALLBACK_GALLERY = {
  items: [
    ...
    { id: 'viki-3ds',       project: 'vikishop', type: 'image', src: 'assets/img/viki-3ds.webp',       w: 1280, h: 2650, caption: { en: 'Automated 3-D Secure checkout', ru: 'Авто 3-D Secure оплата' } },
    { id: 'viki-payment',   project: 'vikishop', type: 'image', src: 'assets/img/viki-payment.webp',   w: 1280, h: 2650, caption: { en: 'Supplier checkout automation',  ru: 'Автооплата у поставщика' } },
    { id: 'viki-completed', project: 'vikishop', type: 'image', src: 'assets/img/viki-completed.webp', w: 1280, h: 1024, caption: { en: 'Order delivered',               ru: 'Заказ доставлен' } },
  ],
};
